...
Real-world data from **50,000+ proxy sessions** across 250+ unique instances (March--April 2026). Collected from instances that opted in with `HEADROOM_TELEMETRY=on`.
